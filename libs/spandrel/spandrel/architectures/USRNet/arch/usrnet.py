...
from ...__arch_helpers import dpir_basic_block as B
...
class DataNet(nn.Module):
    ...
    def forward(self, x, FB, FBC, F2B, FBFy, alpha, sf):
        FR = FBFy + torch.fft.rfft(alpha * x, 2, onesided=False)
        x1 = cmul(FB, FR)
        ...
        Xest = torch.fft.irfft(FX, 2, onesided=False)
...
class USRNet(nn.Module):
    ...
    def forward(self, x, k, sf, sigma):
        ...
        FBFy = cmul(FBC, torch.fft.rfft(STy, 2, onesided=False))
