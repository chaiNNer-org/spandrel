...
##########################################################################
def conv(in_channels: int, out_channels: int, kernel_size: int, bias=False, stride=1):
    return nn.Conv2d(
        in_channels,
        out_channels,
        kernel_size,
...
class CALayer(nn.Module):
    def __init__(self, channel: int, reduction: int = 16, bias=False):
        super().__init__()
...
class SAM(nn.Module):
    def __init__(self, n_feat: int, kernel_size: int, bias: bool):
        super().__init__()
