...
MAIN_REGISTRY.add(
    ...
    ArchSupport(
        ...
        detect=_has_keys(
            "conv_rgb1.weight",
            "rgb_rb2.body.0.weight",
            "rgb_rb3.body.0.weight",
            "rgb_rb4.body.0.weight",
            "conv_dp1.weight",
            "conv_dp2.weight",
            "dp_rg1.body.0.body.0.weight",
            "dp_rg2.body.0.body.0.weight",
            "dp_rg3.body.0.body.0.weight",
            "dp_rg4.body.0.body.0.weight",
            "bridge1.panprocess.weight",
            "bridge1.spa_process.0.F.conv1.identity.weight",
            "bridge2.panprocess.weight",
            "bridge2.spa_process.0.F.conv1.identity.weight",
            "c_de.weight",
            "tail.0.body.0.body.0.weight",
            "upsampler.conv_1.0.weight",
            "gradNet.upBlock.conv_1.0.weight",
        ),
        load=SGNet.load,
    ),
    ArchSupport(
